...
public abstract class PosWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static PosWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(PosWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<PosDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<PosDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<PosDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<PosDbContext, Task<T>> func)
    {
        T result;
